...
INSERT INTO `permisos_ia` (`id`, `orden`, `tema`, `descripcion`) VALUES (27, 25, 'CONFIGURACIÓN', 'Términos lectivos. NO OTORGAR: RESERVADO PARA EL ADMINISTRADOR');
INSERT INTO `permisos_ia` (`id`, `orden`, `tema`, `descripcion`) VALUES (28, 26, 'CONFIGURACIÓN', 'Niveles educativos. NO OTORGAR: RESERVADO PARA EL ADMINISTRADOR');
...
INSERT INTO `permisos_ia` (`id`, `orden`, `tema`, `descripcion`) VALUES (35, 33, 'CONFIGURACIÓN', 'Gestión de planes de estudio. NO OTORGAR: RESERVADO PARA EL ADMINISTRADOR');
INSERT INTO `permisos_ia` (`id`, `orden`, `tema`, `descripcion`) VALUES (36, 34, 'CONFIGURACIÓN', 'Gestión de cursos y materias del plan. NO OTORGAR: RESERVADO PARA EL ADMINISTRADOR');
INSERT INTO `permisos_ia` (`id`, `orden`, `tema`, `descripcion`) VALUES (37, 35, 'CONFIGURACIÓN', 'Gestión de cursos / grados / salas del año. NO OTORGAR: RESERVADO PARA EL ADMINISTRADOR');
INSERT INTO `permisos_ia` (`id`, `orden`, `tema`, `descripcion`) VALUES (38, 36, 'CONFIGURACIÓN', 'Gestión de asignaturas del año. NO OTORGAR: RESERVADO PARA EL ADMINISTRADOR');
