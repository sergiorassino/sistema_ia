...
/**
 * Permiso orden 98 — Estado de deuda por estudiante.
 *
 * Solo inserta/actualiza el catálogo en `permisos_ia` (no modifica `profesores`).
 * Equivalente a database/sql/permiso_ia_orden_98_estado_deuda_estudiante.sql (parte INSERT).
 * Se aplica con php artisan se:migrate-legacy --force
 */
return new class extends Migration
{
    private const ORDEN = PermisosIaCatalog::ADMIN_MORA_ESTADO_DEUDA_ESTUDIANTE;
    ...
    {
        if (Schema::hasTable('permisos_ia')) {
            DB::table('permisos_ia')->where('id', 98)->delete();
        }
    }
};
