...
/**
 * Habilita foto carnet en el ABM de legajos (Secretaría) para San José.
 *
 * Equivalente a database/sql/campos_legajo_foto_carnet_solapa_idempotente.sql.
 * Solo aplica con TENANT_SLUG=sanjose.
 * Autogestión familia: `config/tenants/sanjose.php` → foto_carnet => true.
 *
...
return new class extends Migration
{
    ...
    private function esTenantSanjose(): bool
    {
        return strtolower(trim((string) config('tenant.slug', ''))) === 'sanjose';
    }
