...
/**
 * Habilita foto carnet en el ABM de legajos (Secretaría) para Montecristo.
 *
 * Equivalente a database/sql/campos_legajo_foto_carnet_solapa_idempotente.sql.
 * Solo aplica con TENANT_SLUG=montecristo.
 * Autogestión familia: `config/tenants/montecristo.php` → foto_carnet => true.
 *
...
return new class extends Migration
{
    ...
    private function esTenantMontecristo(): bool
    {
        return strtolower(trim((string) config('tenant.slug', ''))) === 'montecristo';
    }
