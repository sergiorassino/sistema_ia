    ...
    <section class="se-hero">
        <div class="se-hero-inner">
            <div class="min-w-0 space-y-2">
                ...
                <h2 class="text-2xl font-bold tracking-tight sm:text-3xl">Solapas del Legajo</h2>
                <p class="max-w-2xl text-sm text-white/80">
                    Definí las pestañas que aparecen en el formulario de edición del legajo del estudiante.
                </p>
            </div>
    ...
    <div class="se-card overflow-hidden">
        <div class="border-b border-accent-200 bg-white px-5 py-4">
            ...
            <p class="mt-1 text-sm text-neutral-600">
                Cada solapa corresponde a una pestaña en el legajo del estudiante. El <span class="font-mono">slug</span>
                debe ser único y solo usar letras minúsculas, números y guiones.
            </p>
        </div>
                        ...
                        <tr wire:key="solapa-{{ $s->id }}">
                            ...
                            <td class="table-cell text-right">
                                <div class="flex items-center justify-end gap-1">
                                    <button wire:click="subir({{ $s->id }})" title="Subir" class="btn-secondary btn-sm">↑</button>
                                    <button wire:click="bajar({{ $s->id }})" title="Bajar" class="btn-secondary btn-sm">↓</button>
            ...
            <div class="w-full max-w-md overflow-hidden rounded-2xl bg-white shadow-2xl" @click.stop>
                <div class="border-b border-accent-200 px-6 py-4">
                    <h3 class="text-base font-bold text-neutral-900">
                        {{ $editId ? 'Editar solapa' : 'Nueva solapa' }}
                    </h3>
                </div>
                <div class="space-y-4 px-6 py-5">
                    <div>
                        <label class="form-label">Nombre *</label>
                        <input wire:model="nombre" type="text" maxlength="60" autofocus
                    ...
                    <div>
                        ...
                        <input wire:model="slug" type="text" maxlength="30"
                        ...
                        <p class="mt-1 text-xs text-neutral-500">
                            ...
                            Podés cambiar el <strong>nombre</strong> visible sin tocar el slug; si cambiás el slug a algo distinto de alumno, domicilio, madre, padre, tutor o escolar, el formulario del legajo deduce la plantilla según los campos asignados.
                        </p>
                ...
                <div class="flex justify-end gap-3 border-t border-accent-200 bg-accent-50/70 px-6 py-4">
                    ...
                    <button wire:click="guardar" wire:loading.attr="disabled" class="btn-primary">
                        <span wire:loading.remove wire:target="guardar">{{ $editId ? 'Guardar cambios' : 'Crear solapa' }}</span>
            ...
            <div class="w-full max-w-sm overflow-hidden rounded-2xl bg-white shadow-2xl" @click.stop>
                <div class="px-6 py-5">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <h3 class="mb-1 text-base font-semibold text-gray-800">Eliminar solapa</h3>
                            <p class="text-sm text-gray-600">
                                ¿Eliminar «{{ $deleteInfo }}»? Los campos asignados a esta solapa quedarán sin solapa asignada.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="flex justify-end gap-3 px-6 pb-5">
                    ...
                    <button wire:click="eliminar" wire:loading.attr="disabled" class="btn-danger">
