{{-- Descargar Calificaciones desde GE (inicial) --}}
        ...
        <div class="se-hero-inner">
            <div class="min-w-0 space-y-2">
                ...
                <p class="max-w-2xl text-sm text-white/80">
                    Importación de calificaciones exportadas desde <strong>GE</strong> (nivel inicial) ·
    ...
    <div class="se-card space-y-5 p-5 sm:p-6">
        <div class="space-y-2 text-sm text-neutral-600">
            ...
            <ul class="list-disc space-y-1 pl-5">
                <li>Cada fila se asocia al espacio curricular por la columna <strong>M</strong> (<em>Cód. Esp. Curricular</em>) → <code class="text-xs">matplan.codGE</code>.</li>
                <li>Textos del IPE (por materia): <em>Nota Final Etapa 1</em> → <code class="text-xs">obs01</code>; <em>Nota Final Etapa 2</em> → <code class="text-xs">obs02</code>. No se modifican notas. Vacío en el archivo borra el texto.</li>
                <li>Si el texto trae punto y coma y parte la fila CSV, se repara al importar (mismo criterio que la descarga de desempeños).</li>
                <li>La sala se reconoce como <em>SALA DE 3/4/5 AÑOS</em> (o equivalentes).</li>
        ...
        <form wire:submit.prevent="importar" class="space-y-4">
            <div>
                ...
                <label for="sincro-ge-inicial-csv"
                    ...
                    <input id="sincro-ge-inicial-csv"
                           type="file"
                           class="sr-only"
                ...
                @if ($archivoNombre && $encabezadoValido)
                    <div class="mt-3 flex flex-wrap items-center gap-2 rounded-xl border border-emerald-200 bg-emerald-50 px-3 py-2 text-sm text-emerald-900">
                        ...
                        @endif
                        <span class="text-xs text-emerald-800">Formato GE reconocido</span>
                        <button type="button"
