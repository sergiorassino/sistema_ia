{{-- Menú de Docentes: materias a cargo — Cuaderno de Seguimiento Áulico. --}}
<div class="mx-auto w-full max-w-6xl space-y-6">
    <section class="se-hero">
        <div class="se-hero-inner">
            <div class="min-w-0 space-y-2">
                <p class="se-eyebrow">Portal docente · Secundario</p>
                <h2 class="text-2xl font-bold tracking-tight sm:text-3xl">Cuaderno de Seguimiento Áulico</h2>
    ...
    <div class="se-card overflow-hidden">
        ...
        @else
            <style>
                table.se-portal-csa-materias-grid th,
                table.se-portal-csa-materias-grid td {
                    padding-top: 0.5rem;
                    padding-bottom: 0.5rem;
                    padding-left: 0;
                    padding-right: 20mm;
                }
                table.se-portal-csa-materias-grid th:last-child,
                table.se-portal-csa-materias-grid td:last-child {
                    padding-right: 0;
                }
            </style>
            <div class="flex w-full justify-center overflow-x-auto px-3 py-4 sm:px-4">
                <table class="se-portal-csa-materias-grid w-auto table-auto text-sm">
                        ...
                        @foreach ($materias as $fila)
                            <tr class="transition-colors hover:bg-accent-50/60">
                                ...
                                <td class="whitespace-nowrap text-right">
                                    <a href="{{ route('portalDocente.cuadernoSeguimiento.registro', ['curso' => $fila->idCurso, 'materia' => $fila->idMateria]) }}"
