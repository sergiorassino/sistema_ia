{{-- Boletín IPE (primario): informe de progreso escolar en PDF. --}}
<div class="mx-auto w-full max-w-5xl space-y-6">
    ...
    <div class="se-toolbar flex-col !items-stretch gap-4 lg:flex-row lg:items-end">
        <div class="min-w-0 flex-1">
            <label for="se-boletin-ipe-curso" class="form-label">Curso</label>
            <select id="se-boletin-ipe-curso" wire:model.live="cursoId" class="form-select mt-1.5 w-full max-w-xl">
                ...
                <table class="w-max max-w-full table-auto divide-y divide-accent-200 text-sm">
                    ...
                    <tbody class="divide-y divide-accent-100 bg-white">
                        @forelse ($matriculas as $mat)
                            <tr class="hover:bg-accent-50/60" wire:key="boletin-ipe-mat-{{ $mat->id }}">
                                ...
                                <td class="py-3 pl-2 pr-5 text-right align-middle">
                                    <x-pdf-post-matricula
                                        ...
                                        {{ $etiquetaPdf ?? 'INFORME DE PROGRESO ESCOLAR' }}
                                    </x-pdf-post-matricula>
                                </td>
                            </tr>
                        @empty
