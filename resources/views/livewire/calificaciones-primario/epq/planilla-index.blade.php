{{-- Planilla de calificaciones EPQ — curso, luego materias; una hoja PDF por espacio curricular. --}}
...
<div class="mx-auto w-full max-w-4xl space-y-6">
    ...
    <div class="se-card px-5 py-5">
        ...
        <div class="mt-4 max-w-xl">
            <label for="se-epq-planilla-curso" class="form-label">Curso</label>
            <select id="se-epq-planilla-curso"
            ...
            <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    ...
                    <p class="mt-1 text-sm text-neutral-600">
                        ...
                        Cada materia marcada genera su propia hoja con seguimiento pedagógico.
                    </p>
                </div>
