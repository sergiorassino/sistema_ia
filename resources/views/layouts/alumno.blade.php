...
<aside x-ref="seSidebar"
    ...
    <nav class="flex-1 relative z-[1] px-2.5 py-3 overflow-y-auto space-y-0.5"
        ...
        @if (tenantAutogestionCusHabilitada())
            <a href="{{ se_route_url('alumnos.cus') }}"
               target="_blank"
               rel="noopener noreferrer"
               class="se-sidebar-link flex items-center gap-2 px-2.5 py-2 rounded-md transition-colors"
               title="Imprimir C.U.S. — Certificado Único de Salud (se abre en una nueva pestaña)">
                <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                          d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                </svg>
                <span x-show="!sidebarCollapsed" x-cloak class="truncate">Imprimir C.U.S.</span>
            </a>
        @endif

        @if (tenantAutogestionIsaHabilitada())
            <a href="{{ se_route_url('alumnos.isa') }}"
               target="_blank"
               rel="noopener noreferrer"
               class="se-sidebar-link flex items-center gap-2 px-2.5 py-2 rounded-md transition-colors"
               title="Imprimir I.S.A. — Informe de Salud Anual (se abre en una nueva pestaña)">
                <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                          d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"/>
                </svg>
                <span x-show="!sidebarCollapsed" x-cloak class="truncate">Imprimir I.S.A.</span>
            </a>
        @endif
