...
@if (puedeConsultarLegajosDocentes() || tienePermiso($permAsignacionPpc) || tienePermiso(23) || tienePermiso($permCertServicios) || tienePermiso($permCapacitacion))
    <div class="mt-4"></div>
    <button type="button"
            ...
            title="{{ seSidebarTooltip('Docentes / Usuarios v1.0', [11, 48, 23, $permCertServicios, $permCapacitacion]) }}">
