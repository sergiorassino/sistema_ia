...
/**
 * EPQ — Informe de calificaciones secundario: selección de alumnos y PDF individual o en lote.
 */
class BoletinEpqSecundarioIndex extends Component
{
    ...
    public function render()
    {
        ...
        $etiquetaMenu = tenantBoletinSecundarioMenuEtiqueta();

        return view('livewire.calificaciones-secundario.epq.boletin-index', [
            'cursos' => $this->cursos(),
            ...
            ->layout(layoutMenuStaff(), ['pageTitle' => $etiquetaMenu]);
    }
}
