            ...
            [
                ...
                'modulos'     => [
                    ...
                    self::mod(
                        ...
                        'Importa el CSV InasistenciasDetalle exportado desde GE/CIDI; omite presentes y registra ausencias, llegadas tarde y retiros. El texto CIDI del catálogo es la base del tipo (ej. AUSENTE); just se obtiene del CSV.',
                        [
                            'Exporte desde CIDI el listado InasistenciasDetalle (CSV con punto y coma).',
                            'En la pantalla de sincronización, cargue en cada tipo el «texto CIDI» base (sin JUSTIFICADO/INJUSTIFICADO, ej. AUSENTE) y guarde.',
                            'Suba el archivo con el ciclo lectivo y nivel correctos en sesión.',
                            'Revise el resumen: filas registradas, eliminadas previas de CIDI, presentes omitidos y detalle de errores (alumno no matriculado, tipo no mapeado, etc.).',
                            'Habilite el permiso IA orden 24 para el personal que deba importar.',
                        ],
                        [
                            'El alumno se identifica por DNI; las novedades van a su matrícula del ciclo/nivel activos aunque el curso del CSV CIDI no coincida (p. ej. cambio de división).',
                            'La justificación (J/I) se extrae de la columna Tipo del CSV (contiene INJUSTIFICADO → I; resto → J). Un solo concepto AUSENTE cubre ambas justificaciones.',
                            'Antes de insertar se borran las inasistencias previas con obs=CIDI del ciclo y nivel activos; las cargadas a mano no se tocan.',
                        ],
                        'Permiso IA orden 24',
                    ),
                ],
            ...
            [
                ...
                'modulos'     => [
                    ...
                    self::mod(
                        ...
                        'PDF de la grilla por curso o por docente. Disponible para cualquier usuario del Menú de Secretaría (no requiere el permiso 13).',
                        [
