...
/**
 * Impresos TEA Caixal SF (TCPDF, diseño legacy ScriptCase por situación).
 */
final class TeaRegistroCaixalsfTcpdf extends TCPDF
{
    ...
    private function dibujarTipo2InformeDirectivosCitacion(): void
    {
        ...
        $this->Ln(6);
        $this->dibujarCuerpoTipo2Informe();
        ...
        $this->Ln(2);
        $this->dibujarCuerpoTipo2Citacion();
    ...
    {
        $this->dibujarEncabezadoActaCompromisoCitacion();
    ...
    private function dibujarEncabezadoNotificacionTea(): void
    {
        ...
        $this->SetXY($x, $y + 4);
        TcpdfFuenteArial::aplicar($this, '', 11);
        $this->Cell($w + 10, 6, $insti !== '' ? $insti : 'Institución', 0, 2, 'C');
    ...
    private function dibujarEncabezadoActaCompromisoCitacion(): void
    {
        $x = self::MARGEN_IZQ;
        $y = self::Y_ENCABEZADO_TIPO2;
        $w = self::ANCHO_BLOQUE;
        ...
        TcpdfFuenteArial::aplicar($this, '', 8);
        $this->Cell($w + 10, 3.5, 'ACTA COMPROMISO – 10 INASISTENCIAS JUSTIFICADAS O NO', 0, 2, 'C');
        $this->Cell($w + 10, 3.5, 'CITACIÓN A ADULTOS RESPONSABLES', 0, 2, 'C');
...
Nos dirigimos a ustedes para informarles, en cumplimiento a lo establecido por la Resolución 11/25 del Ministerio de Educación de la Provincia de Córdoba; que el estudiante '
...
Ante cualquier duda o inconveniente, estamos a disposición para dialogar sobre estrategias que favorezcan la asistencia regular del estudiante.</p>
<p>Atentamente,</p>';

        $this->writeHTML($html, true, false, true, false, '');
    }

    private function dibujarCuerpoTipo2Informe(): void
    {
        ['apellido' => $apellido, 'nombre' => $nombre, 'dni' => $dni, 'total' => $total] = $this->variablesAlumnoHtml();
...
<p>Nos dirigimos a ustedes para informarles, en cumplimiento a lo establecido por la Resolución 11/25 del Ministerio de Educación de la Provincia de Córdoba; que el estudiante '
...
<p>Se adjunta la citación para los adultos responsables, con el fin de coordinar una reunión con la Preceptoría de la institución, el día ....................... a las .......... horas.</p>
<p>Atentamente,</p>';

        $this->writeHTML($html, true, false, true, false, '');
    }

    private function dibujarCuerpoTipo2Citacion(): void
    {
        ['apellido' => $apellido, 'nombre' => $nombre, 'dni' => $dni, 'total' => $total] = $this->variablesAlumnoHtml();
        ...
        $html = '<p>Estimada familia: </p>
<p>Nos dirigimos a ustedes para informarles, en cumplimiento a lo establecido por la Resolución 11/25 del Ministerio de Educación de la Provincia de Córdoba; que el/la estudiante '
            .$apellido.', '.$nombre.', DNI: '.$dni.', <b>ha registrado '.$total.' inasistencias de las cuales 5 son injustificadas</b> en el presente ciclo lectivo.</p>
<p>Solicitamos su presencia en la institución el día ....................... a las .......... horas para dialogar sobre la situación y acordar estrategias para mejorar su asistencia.</p>
<p>Esperamos contar con su presencia y colaboración.</p>
<p>Atentamente,</p>';
...
<p>Solicitamos su presencia en la institución el día ....................... a las .......... horas para firmar el <b>Acta Compromiso</b> con el objetivo de garantizar la asistencia del estudiante a clase.</p>
...
<p>Atentamente,</p>';
    ...
    private function dibujarCuerpoTipo4Acta(): void
    {
        ...
        $html = '<style>p { line-height: 2; }</style><p>En la ciudad de '.$localidad.' siendo las ................ horas, se reúnen en la institución educativa '
            .$insti.' un representante del equipo directivo, el estudiante '.$apellido.', '.$nombre.' DNI: '.$dni.', el/los Adulto/s responsable/s del estudiante, y el/la preceptor/a con el objetivo de abordar la situación de inasistencias acumuladas (20 inasistencias) lo que coloca su <b>trayectoria escolar en situación de riesgo</b> y en cumplimiento de la Resolución 11/25 del Ministerio de Educación de la Provincia de Córdoba.</p>
...
• Acordar con la familia y el estudiante la mejora en la asistencia para evitar que llegue a condición de &quot;Estudiante en Trayectoria Asistida (TEA)&quot;.<br>
...
• Se ofrece acompañamiento a través del Equipo de Orientación.<br></p>';
    ...
    private function dibujarCuerpoTipo5Notificacion(): void
    {
        ...
        $html = '<style>p { line-height: 2; }</style><p>En la ciudad de '.$localidad.' siendo las ................ horas, se reúnen en la institución educativa '
            .$insti.' un representante del equipo directivo, el estudiante '.$apellido.', '.$nombre.' DNI: '.$dni.', el/los Adulto/s responsable/s del estudiante, y el/la preceptor/a con el objetivo de notificar que, frente a la cantidad de inasistencias acumuladas (25 inasistencias) el estudiante ha ingresado a la <b>condición de Trayectoria Escolar Asistida (TEA)</b> según lo establecido por la Resolución 11/25 del Ministerio de Educación de la Provincia de Córdoba.</p>
<p>Se informa a la familia que, bajo esta condición, se implementarán estrategias pedagógicas específicas para evitar la desvinculación escolar y garantizar el acceso a los aprendizajes. Se aclara que el estudiante debe continuar asistiendo regularmente a clases.<br></p>';
