    ...
    public static function items(): array
    {
        return [
            ...
            [
                ...
                'nivel' => NivelSistema::INICIAL,
                'modulo' => \App\Support\CalificacionesInicial\CalificacionesInicialModulos::CARGA_NOTAS,
                'menu_config' => 'tenant.portal_docente.menu.inicial.carga_notas',
                'route' => 'portalDocente.calificacionesInicialSfq.carga',
                'active_routes' => [
                    'portalDocente.calificacionesInicialSfq.carga',
                    'portalDocente.calificacionesInicialSfq.carga.indicadores',
                    'portalDocente.calificacionesInicialSfq.carga.observaciones',
                ],
            ...
            [
                'id' => 'inicial.boletin',
                'nivel' => NivelSistema::INICIAL,
                'modulo' => \App\Support\CalificacionesInicial\CalificacionesInicialModulos::BOLETIN,
                'menu_config' => 'tenant.portal_docente.menu.inicial.boletin',
                'route' => 'portalDocente.calificacionesInicialSfq.boletin',
                'active_routes' => [
                    'portalDocente.calificacionesInicialSfq.boletin',
                    'portalDocente.calificacionesInicialSfq.boletin.pdf',
                    'portalDocente.calificacionesInicialSfq.boletin.pdfLote',
                ],
                'label' => 'Informes pedagógicos',
