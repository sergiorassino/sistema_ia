...
4. En Menú de Secretaría, la **carga** de calificaciones primario usa `calificacionesPrimario.*` + permiso IA 71. Informe/IPE y planilla no exigen ese permiso (solo autenticación y contexto); la visibilidad de planilla también exige `CalificacionesPrimarioModulos::moduloActivo()`.
