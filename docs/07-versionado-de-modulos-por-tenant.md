...
Consumir con `tenantExamenesEgresadosVentanaCondicion()`. Detalle: [modulos/examenes-condiciones-adeudadas.md](modulos/examenes-condiciones-adeudadas.md).
...
| **Listados por curso** | `App\Livewire\Listados\ListadoPorCurso`, `ListadoCursoPdfController`, `App\Support\Listados\*`, vistas `resources/views/listados/` | `listados.por-curso`, `listados.por-curso.pdf`, `portalDocente.listados.porCurso` |
